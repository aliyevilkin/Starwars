$(document).ready(function() {
    ...
    var renderCharacter = function(character, renderArea) {
      ...
      var charpower = $("<div class='character-power'>").text(character.power);
      charDiv.append(charName).append(charImage).append(charpower);
    ...
    $("#attack-button").on("click", function() {
      if ($("#defender").children().length !== 0) {
        ...
        defender.power -= attacker.attack * turnCounter;
        ...
        if (defender.power > 0) {
          ...
          attacker.power -= defender.enemyAttackBack;
